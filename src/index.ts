...
import { actionMessage, actionPrev, actionNext, actionRestart, actionSetTheme } from "./application/actions";
...
createProgressSelector(state$).subscribe(({ index, value }) => setScale(bars[index], value));
